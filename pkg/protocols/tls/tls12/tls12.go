...
func handshake(network, ip, port string, timeout time.Duration, ciphers []ciphersuite.CipherSuite, opts Opts) (TLS12, error) {
...
func Scan(network, ip, port string, timeout time.Duration, opts Opts) (TLS12, error) {
