...
func main() {
	...
	r, err := tls10.Probe("tcp", ip, port, 2*time.Second, "")
	if err != nil {
	...
	r, err = tls10.Probe("tcp", ip, port, 2*time.Second, "danielgorbe.com")
	if err != nil {
	...
	r, err = tls10.Probe("tcp", ip, port, 2*time.Second, "elmasy.com")
	if err != nil {
